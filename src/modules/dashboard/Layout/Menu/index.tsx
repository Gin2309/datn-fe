        ...
        >
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              ...
              stroke={activePage === "/dashboard" ? "#FF004D" : "#CED4DA"}
              strokeWidth="2"
              strokeLinecap="round"
        ...
        >
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              ...
              stroke={activePage === "/dashboard/order" ? "#FF004D" : "#CED4DA"}
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
          </svg>
          {isOpen && <h1>My Order</h1>}
        </Link>
        ...
        >
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              ...
              stroke={activePage === "/dashboard/services" ? "#FF004D" : "#CED4DA"}
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
          </svg>
          {isOpen && <h1>All Services</h1>}
        </Link>
      </div>
      ...
      >
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            stroke={activePage === "/dashboard/support" ? "#FF004D" : "#CED4DA"}
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
        </svg>
        {isOpen && <h1>Support</h1>}
      </Link>
    </div>
  );
};
